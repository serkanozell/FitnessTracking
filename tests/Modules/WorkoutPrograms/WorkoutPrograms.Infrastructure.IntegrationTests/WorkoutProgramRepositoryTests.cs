...
public class WorkoutProgramRepositoryTests : IAsyncLifetime
{
    ...
    {
        var program = WorkoutProgram.Create(Guid.NewGuid(), "PPL", null, new DateTime(2025, 1, 1), new DateTime(2025, 3, 31));
    ...
    {
        var program = WorkoutProgram.Create(Guid.NewGuid(), "UL", null, new DateTime(2025, 1, 1), new DateTime(2025, 6, 30));
    ...
    {
        var program = WorkoutProgram.Create(Guid.NewGuid(), "Full Body", null, new DateTime(2025, 1, 1), new DateTime(2025, 3, 31));
    ...
    public async Task GetPagedAsync_ShouldReturnCorrectPageWithTotalCount()
    {
        for (int i = 1; i <= 5; i++)
        {
            var p = WorkoutProgram.Create(Guid.NewGuid(), $"Program {i}", null, new DateTime(2025, i, 1), new DateTime(2025, i + 1, 1));
    ...
    {
        var program = WorkoutProgram.Create(Guid.NewGuid(), "Old", null, new DateTime(2025, 1, 1), new DateTime(2025, 3, 31));
        await _context.WorkoutPrograms.AddAsync(program);
        await _context.SaveChangesAsync();

        program.Update("New", null, new DateTime(2025, 4, 1), new DateTime(2025, 6, 30));
        _sut.Update(program);
        await _context.SaveChangesAsync();
    ...
    {
        var program = WorkoutProgram.Create(Guid.NewGuid(), "ToDelete", null, new DateTime(2025, 1, 1), new DateTime(2025, 3, 31));
        await _context.WorkoutPrograms.AddAsync(program);
        await _context.SaveChangesAsync();
    ...
    {
        var p1 = WorkoutProgram.Create(Guid.NewGuid(), "P1", null, new DateTime(2025, 1, 1), new DateTime(2025, 3, 31));
        p1.AddSplit("S1", 1);
        var p2 = WorkoutProgram.Create(Guid.NewGuid(), "P2", null, new DateTime(2025, 4, 1), new DateTime(2025, 6, 30));
