...
public class WorkoutSessionRepositoryTests : IAsyncLifetime
{
    ...
    public async Task AddAsync_ShouldPersistSessionWithExercises()
    {
        ...
        var session = WorkoutSession.Create(Guid.NewGuid(), programId, Guid.NewGuid(), new DateTime(2025, 6, 15));
    ...
    {
        var session = WorkoutSession.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), DateTime.Now);
    ...
    public async Task GetPagedAsync_ShouldReturnCorrectPage()
    {
        for (int i = 1; i <= 5; i++)
        {
            var s = WorkoutSession.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), new DateTime(2025, 6, i));
    ...
    public async Task GetPagedByProgramAsync_ShouldFilterByProgramId()
    {
        ...
        await _context.WorkoutSessions.AddAsync(WorkoutSession.Create(Guid.NewGuid(), targetProgramId, Guid.NewGuid(), new DateTime(2025, 6, 1)));
        await _context.WorkoutSessions.AddAsync(WorkoutSession.Create(Guid.NewGuid(), targetProgramId, Guid.NewGuid(), new DateTime(2025, 6, 2)));
        await _context.WorkoutSessions.AddAsync(WorkoutSession.Create(Guid.NewGuid(), otherProgramId, Guid.NewGuid(), new DateTime(2025, 6, 3)));
        await _context.SaveChangesAsync();
    ...
    public async Task GetListByProgramAsync_ShouldReturnOnlyMatchingSessions()
    {
        ...
        await _context.WorkoutSessions.AddAsync(WorkoutSession.Create(Guid.NewGuid(), targetId, Guid.NewGuid(), new DateTime(2025, 6, 1)));
        await _context.WorkoutSessions.AddAsync(WorkoutSession.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), new DateTime(2025, 6, 2)));
        await _context.SaveChangesAsync();
    ...
    {
        var session = WorkoutSession.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), new DateTime(2025, 6, 1));
        await _context.WorkoutSessions.AddAsync(session);
        await _context.SaveChangesAsync();
    ...
    {
        var s1 = WorkoutSession.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), new DateTime(2025, 6, 1));
        s1.AddEntry(Guid.NewGuid(), 1, 80m, 10);
        var s2 = WorkoutSession.Create(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), new DateTime(2025, 6, 2));
