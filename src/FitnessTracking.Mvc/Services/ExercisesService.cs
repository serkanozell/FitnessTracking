...
public sealed class ExercisesService(HttpClient httpClient) : IExercisesService
{
    ...
    {
        var payload = new { model.Name, model.PrimaryMuscleGroup, model.SecondaryMuscleGroup, Description = model.Description ?? string.Empty, model.ImageUrl, model.VideoUrl };
